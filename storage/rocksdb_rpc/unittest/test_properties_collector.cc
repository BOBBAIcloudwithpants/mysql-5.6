...
void putKeys(myrocks_rpc::Rdb_tbl_prop_coll *coll, int num, bool is_delete,
...
int main(int argc, char **argv) {
  ...
  myrocks_rpc::Rdb_compact_params params;
  params.m_file_size = 333;
  params.m_deletes = 333;  // irrelevant
  params.m_window = 10;

  myrocks_rpc::Rdb_tbl_prop_coll coll(nullptr, params, 0,
