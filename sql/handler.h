...
enum ha_stat_type
{
  ...
  HA_ENGINE_MUTEX,
  HA_ENGINE_TRX,
  HA_ENGINE_STATUS_BACKGROUND_THREAD,
  HA_ENGINE_STATUS_FILE,
  HA_ENGINE_STATUS_FK,
  HA_ENGINE_STATUS_INSBUFFER,
  HA_ENGINE_STATUS_LOG,
  HA_ENGINE_STATUS_MEMORY,
  HA_ENGINE_STATUS_ROW_OPERATIONS,
  HA_ENGINE_STATUS_SEMAPHORES,
  HA_ENGINE_STATUS_TABLESPACE
};
...
struct handlerton
{
  ...
  */
   ...
   */
  enum handler_create_iterator_result (*create_iterator)(handlerton *hton, enum handler_iterator_type type,
...
public:
  ...
  */
  ...
  ha_statistics() : data_file_length(0), max_data_file_length(0),
